...
const Navbar = () => {
    const navList = <>
        <li><NavLink to={"/home"} className={({ isActive }) => `font-semibold ${isActive ? "text-green-500 border border-green-500" : ""}`}>Home</NavLink></li>
    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            <div className="navbar-start">
                ...
                <h3 className="text-2xl font-bold"><Link to={"/"}>Book Vibe</Link></h3>
            </div>
